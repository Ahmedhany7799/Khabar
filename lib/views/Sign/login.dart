...
import 'package:newsapp/views/Sign/register.dart';
...
import '../../services/authntication/authcubit/cubit/authcubit_dart_state.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocConsumer<AuthcubitDartCubit, AuthStates>(
                            ...
                            child: MaterialButton(
                              onPressed: () {
                                if (_formKey.currentState!.validate() == true) {
                                  BlocProvider.of<AuthcubitDartCubit>(context)
                                      .login(
